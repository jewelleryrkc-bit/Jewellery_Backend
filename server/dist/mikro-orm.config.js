...
exports.default = (0, postgresql_1.defineConfig)({
    ...
    entities: [Post_1.Post, Invoice_1.Invoice, Discount_1.Discount, Messages_1.Messages, PaymentOrder_1.PayPalPayment, Conversation_1.Conversation, SendCoupon_1.SendCoupon, NewsletterSubscriber_1.NewsletterSubscriber, NewsletterCampaign_1.NewsletterCampaign, UserCompanyFollow_1.UserCompanyFollow, SellerCategories_1.SellerCategories, DiscountCoupon_1.DiscountCoupon, DiscountCoupon_1.DiscountUsage, Attribute_1.Attribute, CategoryAttribute_1.CategoryAttribute, Attributeoption_1.AttributeOption, Dummy_1.Dummy, User_1.User, Report_1.Report, ReviewCompany_1.ReviewCompany, Company_1.Company, Products_1.Product, BoughtProduct_1.BoughtProduct, WishlistItem_1.WishlistItem, ProductVar_1.ProductVariation, UserAddress_1.UserAddress, Order_1.Order, Category_1.Category, Admin_1.Admin, CartItem_1.CartItem, Reviews_1.Review],
    dbName: 'rkcdb',
